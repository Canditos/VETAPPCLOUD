...
const CustomerAvatar = ({ name }: { name: string }) => {
  ...
  return (
    <div className={`w-12 h-12 rounded-2xl flex items-center justify-center font-black text-lg transition-all duration-300 group-hover:scale-110 shadow-sm ${colorClass}`}>
      {name?.[0]?.toUpperCase()}
    </div>
  );
};
  ...
  return (
    <div className="max-w-[1600px] mx-auto space-y-10 p-4 md:p-8 animate-in fade-in slide-in-from-bottom-4 duration-1000">
      ...
      <div className="space-y-6">
        ...
        <div className="hidden md:grid grid-cols-[1fr_200px_300px_150px_80px] gap-4 px-8 text-slate-400 dark:text-slate-500 font-black text-[10px] uppercase tracking-[0.2em]">
              ...
              >
                <div className="grid grid-cols-1 md:grid-cols-[1fr_200px_300px_150px_80px] gap-4 items-center bg-white dark:bg-slate-900 p-4 md:p-6 rounded-[2.5rem] border border-slate-100 dark:border-slate-800 hover:border-blue-200 dark:hover:border-blue-900/50 hover:shadow-xl hover:shadow-slate-200/40 dark:hover:shadow-none transition-all duration-300">
                  ...
                  <div className="flex flex-col gap-1.5">
                    {customer.phone && (
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-xs font-black text-slate-700 dark:text-slate-300">{customer.phone}</span>
                      </div>
                    )}
                    {customer.email && (
                      <div className="flex items-center gap-2">
                  ...
                  <div className="text-center">
                    <div className="inline-flex items-center gap-2 px-4 py-2 rounded-2xl bg-slate-50 dark:bg-slate-950 border border-slate-100 dark:border-white/5 font-black text-blue-600 dark:text-blue-400 shadow-sm transition-colors group-hover:border-blue-200 dark:group-hover:border-blue-900/50">
                      <PawPrint size={16} />
