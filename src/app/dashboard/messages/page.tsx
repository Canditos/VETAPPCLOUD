  ...
  return (
    <div className="p-8 space-y-8 max-w-[1600px] mx-auto animate-in fade-in duration-700">
        ...
        <div className="flex gap-4">
          <div className="relative w-72">
            ...
            <Input 
              ...
              className="pl-12 h-14 rounded-2xl bg-white dark:bg-slate-900 border-slate-200 dark:border-white/10 font-bold text-sm tracking-tight"
              value={search}
              onChange={(e) => setSearch(e.target.value)}
            />
          </div>
          <Button variant="outline" size="lg" className="rounded-2xl h-14 px-6 font-black text-[11px] uppercase tracking-widest gap-2">
      ...
      <div className="grid grid-cols-1 gap-6">
        {/* Messages List */}
        <Card className="border-none rounded-[3rem] bg-white dark:bg-slate-900/50 shadow-sm ring-1 ring-slate-200 dark:ring-white/5 overflow-hidden">
          <CardContent className="p-0">
            <div className="grid grid-cols-12 px-8 py-6 border-b border-slate-100 dark:border-white/5 bg-slate-50/50 dark:bg-white/5">
               <div className="col-span-3 text-[10px] font-black text-slate-400 uppercase tracking-widest">Remetente</div>
               <div className="col-span-5 text-[10px] font-black text-slate-400 uppercase tracking-widest">Mensagem / Assunto</div>
               <div className="col-span-2 text-[10px] font-black text-slate-400 uppercase tracking-widest">Data & Hora</div>
            ...
            {isLoading ? (
              ...
              <div className="p-24 text-center">
                 <div className="w-16 h-16 bg-slate-100 dark:bg-white/5 rounded-[2rem] flex items-center justify-center mx-auto mb-4 text-slate-300">
                    <MessageSquare size={32} />
                 </div>
                 <h3 className="text-xl font-black text-slate-900 dark:text-white tracking-tight">Sem mensagens</h3>
                ...
                {filteredMessages.map((msg: any) => (
                  ...
                  >
                    ...
                    <div className="col-span-3 flex items-center gap-4">
                       <div className="w-12 h-12 rounded-2xl bg-blue-100 dark:bg-blue-500/10 text-blue-600 flex items-center justify-center font-black shadow-sm group-hover:scale-110 transition-transform">
                          {msg.owner?.name?.charAt(0) || "U"}
                       </div>
                       <div className="min-w-0">
                          <p className="font-black text-slate-900 dark:text-white text-base tracking-tight truncate">{msg.owner?.name || "Tutor"}</p>
                    ...
                    <div className="col-span-5 pr-8">
                       ...
                       <div className="flex items-center gap-2">
                          <Badge className="bg-slate-100 dark:bg-white/5 text-slate-500 border-none font-black text-[9px] uppercase tracking-widest">
                            ID: {msg.id.slice(-6)}
                          </Badge>
                          {msg.requestId && (
                            <Badge className="bg-blue-500/10 text-blue-500 border-none font-black text-[9px] uppercase tracking-widest">
                              Ref: Agendamento
                            </Badge>
                          )}
                       </div>
                    ...
                    <div className="col-span-2">
                       <div className="flex items-center gap-2 mb-1">
                          ...
                          <p className="text-sm font-black text-slate-700 dark:text-slate-300 tracking-tighter">
                    ...
                    <div className="col-span-2 text-right flex justify-end items-center gap-4">
                       <div className="flex flex-col items-end">
                          <Badge className={cn(
                            "rounded-full px-4 py-1 font-black text-[9px] uppercase tracking-widest border-none",
