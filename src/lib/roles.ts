...
const PERMISSIONS: Record<Resource, Record<Role, CrudLevel>> = {
  ...
  owners:         { SUPER_ADMIN: "CRUD", ADMIN: "CRUD", VETERINARIAN: "CRUD", ASSISTANT: "CRIAR_LER", RECEPTIONIST: "CRIAR_LER" },
  consultations:  { SUPER_ADMIN: "CRUD", ADMIN: "CRUD", VETERINARIAN: "CRUD", ASSISTANT: "CRIAR_LER", RECEPTIONIST: "LER" },
  prescriptions:  { SUPER_ADMIN: "CRUD", ADMIN: "CRUD", VETERINARIAN: "CRUD", ASSISTANT: "LER", RECEPTIONIST: "NONE" },
  exams:          { SUPER_ADMIN: "CRUD", ADMIN: "CRUD", VETERINARIAN: "CRUD", ASSISTANT: "CRIAR_LER", RECEPTIONIST: "NONE" },
  appointments:   { SUPER_ADMIN: "CRUD", ADMIN: "CRUD", VETERINARIAN: "CRUD", ASSISTANT: "CRUD", RECEPTIONIST: "CRUD" },
  billing:        { SUPER_ADMIN: "CRUD", ADMIN: "CRUD", VETERINARIAN: "CRIAR_LER", ASSISTANT: "NONE", RECEPTIONIST: "CRUD" },
  inventory:      { SUPER_ADMIN: "CRUD", ADMIN: "CRUD", VETERINARIAN: "LER", ASSISTANT: "LER", RECEPTIONIST: "LER" },
  team:           { SUPER_ADMIN: "CRUD", ADMIN: "CRUD", VETERINARIAN: "LER", ASSISTANT: "LER", RECEPTIONIST: "LER" },
  settings:       { SUPER_ADMIN: "CRUD", ADMIN: "CRUD", VETERINARIAN: "LER", ASSISTANT: "NONE", RECEPTIONIST: "NONE" },
